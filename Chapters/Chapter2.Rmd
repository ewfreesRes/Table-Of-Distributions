...
\hline
  ...
  ~~P(z) & \\
  \hline
  a \text{ and } b \text{ for recursion} & a=0 \\
   & b=\lambda \\
\hline
\end{array}
\end{matrix}
...
\hline
  p_0 & \frac{1}{1+\beta} \\
\hline
  \small{\small{\text{Probability mass function}}} & \frac{\beta^k}{(1+\beta)^{k+1}} \\
  p_k & \\
\hline
...
\hline
  ...
  ~~P(z) & \\
  \hline
  a \text{ and } b \text{ for recursion} & a=\frac{\beta}{1+\beta} \\
   & b=0 \\
\hline
\end{array}
\end{matrix}
...
\hline
  p_0 &(1-q)^m \\
\hline
  \small{\small{\text{Probability mass function}}} & \binom{m}{k}q^k(1-q)^{m-k} \\
  p_k & \\
\hline
...
\hline
  ...
  ~~P(z) & \\
  \hline
  a \text{ and } b \text{ for recursion} & a=\frac{-q}{1-q} \\
   & b=\frac{(m+1)q}{1-q} \\
\hline
\end{array}
\end{matrix}
...
\hline
  p_0 & (1+\beta)^{-r} \\
\hline
  \small{\small{\text{Probability mass function}}} & \frac{r(r+1)\cdots(r+k-1)\beta^k}{k!(1+\beta)^{r+k}} \\
  p_k & \\
\hline
...
\hline
  \small{\small{\text{Probability mass function}}} & \frac{\lambda^k}{k!(e^\lambda-1)} \\
  p^T_k & \\
\hline
...
\hline
  p^T_1 & \frac{1}{1+\beta} \\
\hline
  \small{\small{\text{Probability mass function}}} & \frac{\beta^{k-1}}{(1+\beta)^k} \\
  p^T_k & \\
\hline
...
\hline
  ...
  ~~P(z) & \\
\hline
  a \text{ and } b \text{ for recursion} & a=\frac{1}{1-q} \\
   & b=\frac{(m+1)q}{1-q} \\
\hline
\end{array}
\end{matrix}
