...
This summarizes selected continuous probability distributions used throughout *Loss Data Analytics*.
...
<div class="tab">
  ...
  <button class="tablinks" onclick="openTab(event, 'fsB')">General Beta</button>
</div>
...
# Limited Expected Values for Continuous Distributions
